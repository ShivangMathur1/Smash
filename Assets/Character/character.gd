...
@export var SPARKS: PackedScene = preload("res://Assets/Particles/sparks.tscn")
...
@export var DASH_CLOUD: PackedScene = preload("res://Assets/Particles/dash_cloud.tscn")
...
@export var BULLET: PackedScene = preload("res://Assets/Character/character_bullet.tscn")
